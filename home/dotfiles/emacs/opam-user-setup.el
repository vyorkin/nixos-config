...
;; ## added by OPAM user-setup for emacs / tuareg ## 51e8b7f6737bf7a13a372ab4c9e2ec5f ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/vyorkin/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
